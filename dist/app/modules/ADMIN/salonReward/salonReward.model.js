...
exports.RewardSalonModel = void 0;
...
const rewardSchema = new mongoose_1.default.Schema({
    ...
    purchaseUser: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "User" }, { default: [] }]
}, { timestamps: true, versionKey: false });
exports.RewardSalonModel = mongoose_1.default.model("RewardSalon", rewardSchema);
